...
| **G2** | None of the chosen posts generated; no idea which source a draft came from | 🟡 **Three causes.** (c) shipped 2026-08-16 — the drawer names the source. (a) shipped 2026-08-17 — an empty grid says why, and found Bible Focus hiding 430 posts behind one assignment. (b) the used marker is still invisible outside the grid window |
