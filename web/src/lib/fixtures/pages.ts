...
* Punchy, straight to the point; include the name and year of the event/person when relevant.
* Strictly under 65 words. No questions.

2. highlightPhrases (gold highlights on the text panel):
* Return 5-8 exact substrings copied verbatim from textOverlay (never fewer than 5).
