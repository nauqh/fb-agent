...
// points, the Review drawer's Edit/Preview. Rounded-full rather than the
// shadcn default `rounded-lg` chip, and the active trigger is a solid pill
// rather than a white card with a shadow — the same shell Settings' Prompts
// tabs use, built by hand there because this component predates it. A second
// implementation of the same look is worse than widening this one, so the
// bespoke version was retired in favour of this.
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center gap-0.5 rounded-full border bg-muted/40 p-1 text-muted-foreground group-data-horizontal/tabs:h-auto group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "",
